...
func NewAuth(hostname, token, username, password, cabundle, cabundlecontent, peerauth, cacert, clientcert, clientkey, vdom, httpproxy string, httpsproxy string, noproxy string) *Auth {
	return &Auth{
		Hostname:        hostname,
		Token:           token,
		Username:        username,
...
func (m *Auth) GetEnvToken() (string, error) {
	token := os.Getenv("FORTIWEB_ACCESS_TOKEN")
...
func (m *Auth) GetEnvHostname() (string, error) {
	h := os.Getenv("FORTIWEB_ACCESS_HOSTNAME")
...
func (m *Auth) GetEnvCABundle() (string, error) {
	c := os.Getenv("FORTIWEB_CA_CABUNDLE")
...
func (m *Auth) GetEnvPeerAuth() (string, error) {
	c := os.Getenv("FORTIWEB_CA_PEERAUTH")
...
func (m *Auth) GetEnvCaCert() (string, error) {
	c := os.Getenv("FORTIWEB_CA_CACERT")
...
func (m *Auth) GetEnvClientCert() (string, error) {
	c := os.Getenv("FORTIWEB_CA_CLIENTCERT")
...
func (m *Auth) GetEnvClientKey() (string, error) {
	c := os.Getenv("FORTIWEB_CA_CLIENTKEY")
