...
var fweb_err = map[string]string{
	...
	"-5104": "FortiWEB connect to cloud server error.",
	"-5105": "Server error.",
	"-5106": "Unknown error.",
	"-5107": "Need token.",
	"-5108": "Invalid token.",
	...
	"-6055": "The FortiWEB license does not support EMS related feature.",
	...
	"-6071": "FortiWEB is not in any cloud autoscaling group",
	"-6072": "Life cycle state of FortiWEB is not InService",
