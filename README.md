...
1. Clone repository to: `$GOPATH/src/github.com/fortinetdev/terraform-provider-fortiweb`.

    ```sh
    $ mkdir -p $GOPATH/src/github.com/fortinetdev; cd $GOPATH/src/github.com/fortinetdev
    $ git clone git@github.com:fortinetdev/terraform-provider-fortiweb
    ```

2. Enter the provider directory and build the provider.

    ```sh
    $ cd $GOPATH/src/github.com/fortinetdev/terraform-provider-fortiweb
    $ make build
    ```
