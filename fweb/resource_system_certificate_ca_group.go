...
// Author: Wayne Chou
// Description: Configure system/certificate.ca_group.
...
func flattenSystemCertificateCaGroup(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectSystemCertificateCaGroup(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("mkey", flattenSystemCertificateCaGroup(o["name"], d, "mkey", sv)); err != nil {
...
func expandSystemCertificateCaGroup(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
